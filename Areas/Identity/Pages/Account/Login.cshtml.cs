...
namespace NBDcase.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //VietTruongTran-Clear userName cookie
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var emp = _context.EmployeeAccs.Where(e => e.Email == Input.Email).FirstOrDefault();
                    if (emp != null)
                    {
