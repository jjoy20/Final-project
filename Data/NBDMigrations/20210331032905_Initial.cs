    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAccs", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidEmployees", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BidEmployees_Bids_BidID",
                        column: x => x.BidID,
                        principalSchema: "NBD",
                        principalTable: "Bids",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BidEmployees_Employees_EmployeeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BidEmployees_BidID",
                schema: "NBD",
                table: "BidEmployees",
                column: "BidID");

            migrationBuilder.CreateIndex(
                name: "IX_BidEmployees_EmployeeID",
                schema: "NBD",
                table: "BidEmployees",
                column: "EmployeeID");
